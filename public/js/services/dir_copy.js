...
// *********** BEGIN D3 ***********
				...
				custom_chart = function(dataSelection) { //start function custom_chart
					...
					circles.exit().transition().duration(0).remove();
				...
				// function displayDataByYear(dataSelection) {
				...
				// 	//console.log(my_mod);
				// };
				// console.log("my_mod", my_mod);
				 
				// my_mod.display_all = display_group_all; //display all charts
				// my_mod.display_year = displayDataByYear; //display year
			 ...
			 //    custom_bubble_chart.init(dataSelection);
				// custom_bubble_chart.toggle_view('transactions');

				// jQuery stuff
				// $(document).ready(function() {
				// 	$('#data-button').click(function() { //bind it to html element with class #view_selection
				// 		console.log("YESSSS");
				// 		var view_type = $(this).attr('id');
				// 		console.log('viewType', view_type);
				// 		// $('#view_selection input').removeClass('active');
