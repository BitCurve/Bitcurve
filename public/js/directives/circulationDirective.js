        ...
        //custom chart that takes in data 
          var custom_chart = function(data) {
            // console.log("data", data);
              ...
              max_circulation = d3.max(data, function(d) { return parseFloat(d.totalCirculation, 10); }); //function for the max data and parsing it into #
              // console.log("max_circulation", max_circulation);
              min_circulation = d3.min(data, function(d) { return parseFloat(d.totalCirculation, 10); }); //function for the max data and parsing it into #
          ...
          vis = d3.select("#circVis").append("svg") //this "#vis" is in index
                  .attr("width", width)
                  .attr("height", height)
                  .attr("id", "svg_vis"); 
      ...
      //GROUPING THE DATA 
        ...
        function move_towards_year(alpha) {
          return function(d) {
            ...
            d.x = d.x + (target.x - d.x) * (damper + 0.02) * alpha; //move_towards_year also multiplies by 1.1 to speed up the transition a bit.
