	...
	.directive('minersData', [function ($location){  
        ...
        //custom chart that takes in data 
          var custom_chart = function(data) {
            console.log("data", data);
              ...
              min_miners = d3.min(data, function(d) { return parseFloat(d.dailyMinersRevenue, 10); }); //function for the max data and parsing it into #
          ...
          vis = d3.select("#mineVis").append("svg") //this "#vis" is in index
                  .attr("width", width)
                  .attr("height", height)
                  .attr("id", "svg_vis"); 
      ...
      //GROUPING THE DATA 
       ...
       //tooltip to hide data details till executred
        ...
        my_mod.display_year = displayminersByYear; //display year
