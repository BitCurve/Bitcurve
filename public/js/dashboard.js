...
d3.csv('../dataset.csv', function (data) {
    ...
    data.forEach(function (d) {
    	// console.log('d.datetime', d.datetime);
        d.dd = dateFormat.parse(d.datetime);
        // console.log('d.dd', d.dd);
        d.month = d3.time.month(d.dd); // pre-calculate month for better performance
        // WW: Still returns the entire date sequence, but it's always as such: 'Fri May 01 2015 00:00:00' -- indicating that the month in question is May. Can we use 'd3.time.year(d.dd).getMonth()' to get the month? 
        // console.log('d.month', d.month); 	
        d.high = +d.high; // coerce to number
